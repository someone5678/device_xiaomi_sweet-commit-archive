...
import static org.lineageos.settings.device.display.LcdFeaturesPreferenceFragment.HBM_MODE_OFF;
import static org.lineageos.settings.device.display.LcdFeaturesPreferenceFragment.HBM_MODE_ON;
import static org.lineageos.settings.device.display.LcdFeaturesPreferenceFragment.HBM_NODE;
import static org.lineageos.settings.device.display.LcdFeaturesPreferenceFragment.HBM_PROP;
...
public class HbmTileService extends TileService {
    ...
    private void updateHbmTile() {
        String enabled = context.getResources().getString(R.string.lcd_hbm_title_enabled);
        String disabled = context.getResources().getString(R.string.lcd_hbm_title_disabled);
